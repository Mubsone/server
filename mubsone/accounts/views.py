...
def testview(request, uname):
    u = get_object_or_404(MubsoneUser, user=uname)
    data = serializers.serialize("json", [ u, ], use_natural_foreign_keys=True, use_natural_primary_keys=True)
    print(data)
